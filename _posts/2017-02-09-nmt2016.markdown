...
#####**图 3（a）传统多语言对翻译；（b）多语言神经机器翻译。**
另一方面，若图14中的中文和日文平行语料库稀缺，则无法利用统计机器翻译构建出中文到日文的直译系统，要实现中文到日文的机器翻译则需要以英文为枢轴语言（pivot language）完成：
 
<img  src="{{ site.baseurl }}/images/2016nmtadvantage/duoyuyandiziyuanfanyi2.jpg" align="middle"  width="770" height="75"/>

#####**图 4 以英文为枢轴语言实现中文到日文的翻译。**
...
<img  src="{{ site.baseurl }}/images/2016nmtadvantage/duoyuyandiziyuanfanyi3.jpg" align="middle"  width="679" height="132"/>


#####**图 5 谷歌多语言翻译系统，通过在源语言端标记目标语言种类区分目标语言，如“<2en>”为翻译到英文；“<2zh>”为翻译到中文。**
